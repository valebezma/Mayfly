...
namespace Mayfly
{
	public class ShellLink : IDisposable
	{
		...
		private interface IShellLinkA
		{
			...
			//[helpstring("Retrieves the shell link command-line args")]
			void GetArguments(
				[Out(), MarshalAs(UnmanagedType.LPStr)] StringBuilder pszArgs, 
				int cchMaxPath);

			//[helpstring("Sets the shell link command-line args")]
			void SetArguments(
		...
		/// <summary>
		/// Gets/sets any command line args associated with the link
		/// </summary>
		public string Arguments
		{
			get
			{				
				StringBuilder args = new StringBuilder(260, 260);
				if (linkA == null)
				{
					linkW.GetArguments(args, args.Capacity);
				}
				else
				{
					linkA.GetArguments(args, args.Capacity);
				}
