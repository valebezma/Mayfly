...
namespace Mayfly.TaskDialogs
{
    ...
    public partial class CredentialDialog : Component
    {
        ...
        /// </summary>
        /// <value>
        /// One of the values of the <see cref="Mayfly.TaskDialogs.DownlevelTextMode"/> enumeration. The default value is
        /// <see cref="Mayfly.TaskDialogs.DownlevelTextMode.MainInstructionAndContent"/>.
        /// </value>
        /// <remarks>
        /// <para>
        ...
        public DialogResult ShowDialog(IWin32Window owner)
        {
            if( string.IsNullOrEmpty(_target) )
                throw new InvalidOperationException(Resources.TaskDialogs.CredentialEmptyTargetError);
        ...
        public void ConfirmCredentials(bool confirm)
        {
            if( _confirmTarget == null || _confirmTarget != Target )
                throw new InvalidOperationException(Resources.TaskDialogs.CredentialPromptNotCalled);
        ...
        public static void StoreCredential(string target, NetworkCredential credential)
        {
            ...
            if( target.Length == 0 )
                throw new ArgumentException(Resources.TaskDialogs.CredentialEmptyTargetError, "target");
            if( credential == null )
