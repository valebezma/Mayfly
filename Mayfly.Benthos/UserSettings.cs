...
namespace Mayfly.Benthos
{
    public abstract class UserSettings
    {
        public static string Path
        {
            get
            {
                return UserSetting.GetFeatureKey("Mayfly.Benthos");
            }
        }
        ...
        public static void Initialize()
        {
            ...
            UserSetting.InitializeRegistry(Path, Assembly.GetCallingAssembly(),
                new UserSetting[] {
                    ...
                    new UserSetting(Wild.UserSettingPaths.LogOrder, Wild.LogOrder.AsInput)
                });
        }
        ...
        public static FileSystemInterface Interface = new FileSystemInterface(Wild.UserSettings.FieldDataFolder, ".bcd", ".html");
        ...
        public static string SpeciesIndexPath
        {
            get
            {
                return Wild.Service.GetReferencePathSpecies(Path, Wild.UserSettingPaths.Species, "Benthos");
            }
