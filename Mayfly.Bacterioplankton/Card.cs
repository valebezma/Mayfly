...
namespace Mayfly.Bacterioplankton
{
    public partial class Card : Form
    {
        ...
        public Card()
        {
            ...
            ColumnObservedArea.ValueType = typeof(double);
        ...
        WaterSkip:
            ...
            Data.Solitary.Square = (double)numericUpDownSquare.Value;

            Data.Solitary.Volume = (double)numericUpDownVolume.Value;
        ...
        Saving:
            ...
            if (gridRow.Cells[ColumnObservedArea.Index].Value == null)
            {
                result.SetSubsampleNull();
            }
            else
            {
                result.Subsample = (double)gridRow.Cells[ColumnObservedArea.Index].Value;
            }
        ...
        private void LoadData()
        {
            ...
            numericUpDownVolume.Value = (decimal)Data.Solitary.Volume;
            numericUpDownSquare.Value = (decimal)Data.Solitary.Square;
        ...
        private void InsertLogRow(Data.LogRow logRow, int rowIndex)
        {
            ...
            if (!logRow.IsSubsampleNull()) gridRow.Cells[ColumnObservedArea.Index].Value = logRow.Subsample;
        ...
        private void SetSubsample(double subsample)
        {
            ...
            {
                gridRow.Cells[ColumnObservedArea.Index].Value = subsample;
            }
        }
        ...
        private void menuItemPrint_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    Data.GetReport(System.IO.Path.GetFileNameWithoutExtension(FileName)).PrintNow();
            //}
            //else
            //{
            //    Data.GetReport(System.IO.Path.GetFileNameWithoutExtension(FileName)).Print();
            //}
        }
        ...
        private void speciesLogger_DuplicateDetected(object sender, DuplicateFoundEventArgs e)
        {
            ...
            statusCard.Message(string.Format(Wild.Resources.Messages.DuplicateSummed,
        ...
        private void contextArea_Opening(object sender, CancelEventArgs e)
        {
            bool hasS = false;

            foreach (DataGridViewCell cell in spreadSheetLog.SelectedCells)
            {
                hasS |= cell.OwningColumn == ColumnObservedArea;
            }

            contextAreaSet.Enabled = hasS;
        }

        private void contextAreaSet_Click(object sender, EventArgs e)
        {

            foreach (DataGridViewCell cell in spreadSheetLog.SelectedCells)
            {
                if (cell.OwningColumn == ColumnObservedArea)
                {
                    ObservedCalc calc = new ObservedCalc(cell);
                    calc.Show();
                    break;
                }
            }
