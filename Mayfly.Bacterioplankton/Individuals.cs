...
namespace Mayfly.Bacterioplankton
{
    public partial class Individuals : Form
    {
        ...
        public Individuals(Data.LogRow logRow)
        {
            ...
            ColumnWidth.ValueType = typeof(double);
            ...
            numericUpDownQuantity.Enabled = !UserSettings.FixTotals;
        ...
        Saving:
            ...
            if (gridRow.Cells[ColumnWidth.Index].Value == null)
            {
                individualRow.SetWidthNull();
            }
            else
            {
                individualRow.Width = (double)gridRow.Cells[ColumnWidth.Index].Value;
            }
        ...
        private DataGridViewRow InsertIndividualRow(Data.IndividualRow individualRow)
        {
            ...
            if (individualRow.IsWidthNull()) { }
            else
            {
                gridRow.Cells[ColumnWidth.Index].Value = individualRow.Width;
            }
