...
namespace Mayfly.Software
{
    public partial class WizardInstall : Form
    {
        ...
        public WizardInstall()
        {
            ...
            comboBoxProduct.DataSource = Service.GetScheme().Product.Select(null, "Name Asc");
            ...
            while (downloadLinks.Count > 0)
            {
                ...
                if (lang != CultureInfo.InvariantCulture)
                {
                    ...
                    try
                    {
                        ...
                        tempFileName = Path.Combine(FileSystem.TempFolder, lang.Name, feature);
        ...
        private void backgroundDownloader_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            UserSetting.InitializeRegistry(UserSettingPaths.KeyGeneral, null,
                new UserSetting[] {
                    ...
                    new UserSetting(UserSettingPaths.Log, true),
                    new UserSetting(UserSettingPaths.LogSpan, 30),
                    new UserSetting(UserSettingPaths.LogSend, true),
                    new UserSetting(UserSettingPaths.LogSentLast, new DateTime(2018, 3, 1)),
            ...
            UserSetting.SetValue(UserSettingPaths.KeyFeatures, /*SelectedProduct.Name,*/ UserSettingPaths.UpdatePolicy, (int)UpdatePolicy.CheckAndNotice);
        }
