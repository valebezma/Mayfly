...
namespace Mayfly.Benthos.Explorer
{
    partial class MainForm
    {
        ...
        ////    result.Cells[columnSpcOccurrence.Index].Value = FullStack.GetOccurrence(taxonRow.GetSpecies());
        ...
        //private void LoadIndLog(SpeciesKey.TaxonRow speciesRow)
        //{
